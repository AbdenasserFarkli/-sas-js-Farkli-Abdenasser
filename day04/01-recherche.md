...
Un paramètre est une variable que nous utilisons lorsque nous définissons une fonction.

Un argument est la valeur que nous donnons à ce paramètre lorsque nous appelons la fonction.
...
return te renvoie une valeur.

console.log() affiche uniquement le contenu que tu lui donnes.
> À compléter avec mes propres mots.
...
Si tu oublies return, la fonction ne renvoie aucune valeur. Par conséquent, si tu essaies de l’afficher, elle renverra None.
> À compléter avec mes propres mots.
...
Une variable locale ne peut pas être utilisée à l’extérieur de la fonction.
- [ ] J'ai recherché et compris la notion.

En JavaScript, il existe deux types de variables : le premier est global, c’est-à-dire une variable déclarée en dehors d’une fonction, et le deuxième est local, c’est-à-dire une variable déclarée à l’intérieur d’une fonction.
...
Oui, dans le cas où une fonction ne renvoie qu’une seule chose.
> À compléter avec mes propres mots.
...
C’est une fonction qui reçoit une autre fonction.
> À compléter avec mes propres mots.
...
Oui, on peut donner une valeur par défaut.
> À compléter avec mes propres mots.
...
La récursivité est une fonction qui s’appelle elle-même afin de réaliser une condition donnée.
- [ ] J'ai recherché et compris la notion.
