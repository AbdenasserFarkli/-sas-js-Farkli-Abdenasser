...
let montantEmprunte=100000 , dureeEnMois=24 , revenuMensuel= 8000,  mensualité= montantEmprunte/dureeEnMois
if (mensualité > (revenuMensuel/100*30)) {
    if (revenuMensuel > 10000) 
        console.log("Je vous propose d’augmenter la durée du prêt en mois.");
        
    else
        console.log("Prêt refusé");
      
}else
    console.log("Prêt accordé: "+ mensualité +" MAD/Mois");
